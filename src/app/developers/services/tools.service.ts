...
export class ToolsService {
  ...
  createDatabase(
    ...
    return this.http
      .post(
        `${this.databaseUrl}/${digitalProfileId}`,
        database,
        this.httpOptions
      )
      .pipe(retry(2), catchError(this.handleError));
  ...
  createFramework(
    ...
    return this.http
      .post(
        `${this.frameWorkUrl}/${digitalProfileId}`,
        framework,
        this.httpOptions
      )
      .pipe(retry(2), catchError(this.handleError));
  ...
  createProgrammingLanguage(
    ...
    return this.http
      .post(
        `${this.programingLanguageUrl}/${digitalProfileId}`,
        programmingLanguage,
        this.httpOptions
      )
      .pipe(retry(2), catchError(this.handleError));
  ...
  createStudyCenter(
    ...
    return this.http
      .post(
        `${this.studyCenterUrl}/${educationId}`,
        studyCenter,
        this.httpOptions
      )
      .pipe(retry(2), catchError(this.handleError));
